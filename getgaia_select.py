...
def manual_select_from_cmd(args, data):
   ...
   fig, ((ax1, ax2, ax3), (ax4, ax5, ax6)) = plt.subplots(2,3, figsize = (10., 7.5), subplot_kw = subplot_kw)
   plt.subplots_adjust(right=0.85, wspace = 0.5, hspace = 0.1, bottom=0.15)
...
def plot_final_selection(args, data, plot_prob = True):
   ...
   plt.close('all')
   subplot_kw = dict(autoscale_on = False)
   fig, ((ax1, ax2, ax3), (ax4, ax5, ax6)) = plt.subplots(2,3, figsize = (10.0, 7.5), subplot_kw = subplot_kw)
   plt.subplots_adjust(right=0.85, wspace = 0.5, hspace = 0.1, bottom=0.15)
